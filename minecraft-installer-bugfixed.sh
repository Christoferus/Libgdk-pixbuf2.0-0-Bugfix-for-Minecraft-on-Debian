...
log "Copying Minecraft.deb to work directory..."
...
log "Adjusting ownership to current user for editing..."
sudo chown -R "$USER":"$USER" "$SRC_DIR"

log "Writing corrected control file..."
# NOTE: Replace the bad dependency (lib-gdk2.0-0) with the correct one (libgdk-pixbuf-2.0-0).
# Also bump version so your rebuilt package is distinguishable.
